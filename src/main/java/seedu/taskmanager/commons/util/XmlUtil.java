...
public class XmlUtil {
     ...
     * @param file
     *            Points to a valid xml file containing data that match the {@code classToConvert}. Cannot be null.
     ...
     *             Thrown if the file is missing.
     * @throws JAXBException
     *             Thrown if there is an error during converting the data into xml and writing to the file.
     */

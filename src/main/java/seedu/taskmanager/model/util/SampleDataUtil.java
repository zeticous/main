    ...
    public static Task[] getSampleTasks() {
        try {
            return new Task[] {
                ...
                new Task(new Name(DDL1_NAME), null, new TaskDate(DateTimeUtil.parseEndDateTime(DDL1_DUE_TIME_STRING)),
                        new UniqueTagList()),
                ...
                new Task(new Name(DDL2_NAME), null, new TaskDate(DateTimeUtil.parseEndDateTime(DDL2_DUE_TIME_STRING)),

...
public class LogicManagerTest {
    ...
    class TestDataHelper {
        ...
        Task adam() throws Exception {
            ...
            return new Task("FIX THIS SHIT", "08/03/2017 10:23", "08/03/2017 19:23", tags);
        }
        ...
        Task generateTask(int seed) throws Exception {
            UniqueTagList tags = new UniqueTagList(new Tag("tag" + Math.abs(seed)), new Tag("tag" + Math.abs(seed + 1)));
            return new Task("FIX THIS SHIT", "08/03/2017 10:23", "08/03/2017 19:23",tags);
        }
        ...
        Task generateTaskWithName(String name) throws Exception {
            return new Task("FIX THIS SHIT", "08/03/2016 11:11", "09/03/2017 11:11", new UniqueTagList());
        }
    }
}
